        ...
        <div className="grid grid-cols-1 gap-6 xl:grid-cols-[1.6fr_1fr]">
          ...
          <div className="rounded-3xl bg-[#edf3f9] p-5 shadow-md">
            ...
            <div className="overflow-x-auto rounded-2xl">
              <table className="w-full min-w-[760px] bg-white text-left rounded-2xl overflow-hidden">
                <thead>
          ...
          <div className="rounded-3xl bg-[#edf3f9] p-5 shadow-md">
            ...
            <div className="overflow-x-auto rounded-2xl">
              <table className="w-full bg-white text-left rounded-2xl overflow-hidden">
                <thead>
                  <tr className="bg-[#e5edf6] text-sm text-[#335574]">
